						...
						<div class="col">
							<div class="card shadow mb-4">
								<div
									...
									<h6 class="m-0 font-weight-bold text-primary">${d.professorNo}</h6>
								</div>
								<div class="card-body">
									<div class="row mb-3">
										<div class="col-sm-1 font-weight-bold">제목</div>
										<div class="col-sm-11 text-muted">${d.noticeTitle}</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-1 font-weight-bold">작성자</div>
										<div class="col-sm-11 text-muted">${d.professorNo}</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-1 font-weight-bold">내용</div>
										<div class="col-sm-11 text-muted">${d.noticeContents}</div>
									</div>
									...
									<div class="d-flex justify-content-end mt-4">
										<a class="btn btn-primary btn-icon-split mr-2"
											href="./update?noticeNo=${d.noticeNo}"> <span
										...
										<form action="./delete" method="post"
											...
											<input type="hidden" name="noticeNo" value="${d.noticeNo}">
