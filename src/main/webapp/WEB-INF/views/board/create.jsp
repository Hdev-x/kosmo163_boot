									...
									<form action="./create" method="post" enctype="multipart/form-data">
										<div class="form-group">
											<label for="title" class="font-weight-bold">제목 </label> <input
												...
												name="noticeTitle" placeholder="">
										</div>
										<div class="form-group">
											<label for="writer" class="font-weight-bold">작성자 </label> <input
												type="text" class="form-control" id="professorNo"
												name="ProfessorNo" placeholder="">
										</div>
										<div class="form-group">
											<label for="contents" class="font-weight-bold">내용</label>
											<textarea rows="12" cols="" class="form-control"
												id="contents" name="noticeContents" placeholder=""></textarea>
										</div>
